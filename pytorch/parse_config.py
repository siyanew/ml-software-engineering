...
from pytorch.logger import setup_logging
from pytorch.utils import read_json, write_json
...
class ConfigParser:
    def __init__(self, config, resume=None, modification=None, run_id=None):
        ...
        :param run_id: Unique Identifier for training processes. Used to save checkpoints and training log. Timestamp
